...
imgplot[2][1].imshow(imgEq1, cmap='gray')
imgplot[2][2].imshow(imgEq2, cmap='gray')
imgplot[2][0].imshow(imgEq3, cmap='gray')
...
imgLocEq1 = localHistogramEqualization(img1, blockSize)
imgLocEq2 = localHistogramEqualization(img2, blockSize)
imgLocEq3 = localHistogramEqualization(img3, blockSize)

imgplot[4][1].imshow(imgLocEq1, cmap='gray')
imgplot[4][2].imshow(imgLocEq2, cmap='gray')
imgplot[4][0].imshow(imgLocEq3, cmap='gray')
